...
title: Relatório Sintético de Curso - Autoavaliação UFRPE 2020
output: 
  html_document:
...
<div class = "warning">
OBSERVAÇÃO: este relatório apresenta os resultados da avaliação da UFRPE *como um todo* sob o ponto de vista dos estudantes deste curso; sendo assim, não deve ser interpretado como uma avaliação do curso propriamente dito.
</div>
